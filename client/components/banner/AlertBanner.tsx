  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5">
        ...
        <span className={`${messageFont} text-[14px] tracking-tight ${text}`}>
          {message}
        </span>
      </div>
      ...
      {actionText && onActionAction && (
        <button
          ...
          className={`flex items-center ${actionFont} text-[12px] tracking-tight transition-opacity hover:opacity-80 ${text}`}
        >
          {actionText}
