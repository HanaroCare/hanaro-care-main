  ...
  return (
    <div className="flex flex-col items-center justify-center pt-[5rem]">
      <div className="relative mb-[3rem] flex h-[9rem] w-[9rem] items-center justify-center">
        <motion.div
          className={`absolute h-full w-full rounded-full border-[3px] transition-colors duration-500 ${
            status === "success"
              ? "border-hana-green-500"
        ...
        />
        <ScanFace
          className={`h-[4.5rem] w-[4.5rem] transition-colors duration-500 ${
            status === "success" ? "text-hana-green-500" : "text-primary"
          }`}
        />
      </div>
