      ...
      <div className="app-layout">
        ...
        <div className="app-main">
          <div className={styles.container}>
            ...
            <div className={styles.chartImageContainer} style={{ height: '220px', position: 'relative' }}>
              ...
              <div style={{
                ...
                <span style={{ fontSize: '14px', color: 'var(--color-hana-black-500)', fontWeight: 500 }}>총 합계</span><br/>
                <span style={{ fontSize: '20px', fontWeight: 800, color: 'var(--color-hana-ez-600)' }}>{totalPercentage}%</span>
              </div>
            </div>
