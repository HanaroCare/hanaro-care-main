...
export function MedicalBillCard({
  ...
  return (
    ...
    >
      <h2 className="whitespace-pre-line text-center font-bold text-[19px] text-hana-black-800 leading-[26px]">
        이번달 요양보호사{'\n'}카드 지출{' '}
      ...
      <div className="w-full space-y-2">
        ...
        <div className="h-[11px] w-full rounded-full bg-hana-silver-100">
          <motion.div
            initial={{ width: 0 }}
