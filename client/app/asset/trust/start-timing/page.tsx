...
export default function TrustStartTimingPage() {
	...
	return (
		...
		>
			<section className="px-6 pt-8">
				<TrustProgressBar step={2} />

				<div className="mt-14">
					<p className="text-[22px] leading-[1.45] font-bold tracking-tight text-black">
						언제부터
						<br />
						<span className="text-hana-ez-600">시작</span>할까요?
					</p>
					<p className="mt-3 text-sm leading-5 font-normal tracking-snug text-[#6A7282]">
						지점에서 바꿀 수 있어요
					</p>
				</div>
							...
							>
								<div className="flex items-center justify-between gap-3">
									<div className="min-w-0">
										<p className="text-base leading-6 font-semibold tracking-tight text-[#1F2937]">
											{option.title}
										</p>
