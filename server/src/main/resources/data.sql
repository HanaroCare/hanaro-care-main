...
VALUES
    ...
    (9017, 4002, 'CU 논현점',          '서울 강남구 논현로 339',         'SPEND', 5800.00,   'N', 'Y'),
    (9018, 4002, '롯데마트 강남점',    '서울 강남구 대치동 942',         'SPEND', 55000.00,  'N', 'Y'),
    (9019, 4002, '강남세탁소',         '서울 강남구 역삼로 211',         'SPEND', 15000.00,  'N', 'Y'),
    (9020, 4002, '한강공원 편의점',    '서울 강남구 강남대로 지하 396',  'SPEND', 8200.00,   'N', 'Y');
...
VALUES (1, 1001, 1002, 'CHILD',  1, 1, 1, 1, 4001),
       ...
       (4, 1001, 1005, 'PARENT', 1, 1, 1, 1, NULL);
