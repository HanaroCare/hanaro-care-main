...
-- 비밀번호: 1234 (BCrypt)
-- ========================
INSERT INTO TB_USER (USER_ID, USER_NM, USER_PWD, USER_PHONE, USER_AGE, HANA_CERT_YN, USER_STAT_CD, USER_ROLE)
VALUES
    (12345678, 'min', '$2a$12$Pet4YZqRx2T9JUnS/Xv9L.VN4NkDPEjwi6lcG2gn7o5ushhL30jnK', '01012345678', 25, 1, 'ACTIVE', 'ROLE_USER'),
    (1001, '홍길동', '$2a$12$Pet4YZqRx2T9JUnS/Xv9L.VN4NkDPEjwi6lcG2gn7o5ushhL30jnK', '01011112222', 65, 1, 'ACTIVE', 'ROLE_USER'),
    (1002, '김철수', '$2a$12$Pet4YZqRx2T9JUnS/Xv9L.VN4NkDPEjwi6lcG2gn7o5ushhL30jnK', '01022223333', 70, 0, 'ACTIVE', 'ROLE_USER'),
    (1003, '이영희', '$2a$12$Pet4YZqRx2T9JUnS/Xv9L.VN4NkDPEjwi6lcG2gn7o5ushhL30jnK', '01033334444', 68, 1, 'ACTIVE', 'ROLE_USER');
-- ========================
-- 2. TB_REFRESH_TOKEN (인증 토큰)
-- ========================
INSERT INTO TB_REFRESH_TOKEN (USER_ID, TOKEN_VAL, EXPIRY_DT)
VALUES
    (12345678, 'dummy-refresh-token-val-min', '2026-12-31 23:59:59'),
...
VALUES
    (1, '하나 연금신탁', '안정적인 노후 연금 상품', 'PENSION'),
...
VALUES
    (1, 2006, '하나 시니어 행복카드', 2000000.00, 500000.00, 'Y');
...
VALUES
    (3001, 1001, '역삼동 아파트', 'REAL_ESTATE', 920000000.00, '서울 강남구 역삼동 123-45', 84.00, '홍길동 자택'),
...
VALUES
    (1001, 85, 1500000.00, 500000.00, 300000.00, 2300000.00, '{"70s": 200, "80s": 250}');

-- ========================
-- 8. TB_TRUST_SIMULATION (신탁 시뮬레이션)
-- ========================
INSERT INTO TB_TRUST_SIMULATION (USER_ID, PRINCIPAL_AMOUNT, INVEST_TYPE, PAYOUT_TYPE, START_TYPE, START_DATE, PAYOUT_SETTINGS)
VALUES
    (1001, 100000000.00, 'LUMP_SUM', 'PENSION', 'NOW', '2026-04-14', '{"monthly": 150}');

-- ========================
-- 9. TB_FAMILY_AUTH (가족 권한)
-- ========================
INSERT INTO TB_FAMILY_AUTH (USER_GRANTOR_ID, USER_GRANTEE_ID, RELATION_CD, AUTH_STATUS, CARD_VIEW_YN, INS_VIEW_YN, CARD_ID)
VALUES
    (1001, 12345678, 1, 1, 'Y', 'Y', 1);
...
VALUES
    (1, '아들아, 건강하게만 자라다오.', 'http://s3.aws.com/voice1.mp3', 'VOICE');

-- ========================
-- 13. TB_USER_PROD (가입 상품)
-- ========================
INSERT INTO TB_USER_PROD (USER_PROD_ID, USER_ID, PRODUCT_ID, PROD_STAT_CD, PROD_TYPE_CD, PAYOUT_TYPE_CD, PRINCIPAL_AMOUNT, START_DATE)
VALUES
    (1, 1001, 1, 'IN_PROGRESS', 'TRUST', 'PENSION', 50000000.00, '2026-01-01');

-- ========================
-- 14. TB_ASSET_TRANS (자산 거래 내역)
-- ========================
INSERT INTO TB_ASSET_TRANS (USER_PROD_ID, TRANS_AMT, TRANS_STAT_CD, TRANS_TYPE_CD)
VALUES
    (1, 1500000.00, 'COMPLETED', 'PAYMENT');
...
VALUES
    (3, 12345678, 'SIMPLE_PASSWORD', '$2a$12$vobmM3uRVFkpxmZtUm0j7O6cvlJiuhS.501d3rsLFkCFMOaveg3Su');
