...
VALUES
    ...
    -- ── [1003 이영희] 휴면 계정 (연금 미연동 시나리오) ────────────────────
    (2009, 1003, '국민은행',    'KB스타트예금',         '666-777-100301', 125000.00,    'CASH',      0.1,  1,  0,       0,      '2019-02-15', '2099-12-31', 0,           1),
    (2010, 1003, '삼성증권',    'CMA 계좌',             '888-999-100302', 54000.00,     'STOCK',     1.2,  1,  0,       0,      '2020-05-20', '2099-12-31', 0,           1),
    -- 국민연금 미연동 → NationalPensionService가 통계 추정치(450,000) 사용

    -- ── [1004 박관리] 테스트용 관리자 ────────────────────────────────────
    (2011, 1004, '하나은행',    '관리자 테스트 통장',   '000-000-100401', 10000000.00,  'CASH',      0.1,  1,  0,       0,      '2024-01-01', '2099-12-31', 0,           1),
    (2012, 1004, '하나증권',    '테스트 주식계좌',      '000-000-100402', 5000000.00,   'STOCK',     10.0, 1,  0,       0,      '2024-01-01', '2099-12-31', 0,           1),
    (2013, 1004, '하나생명',    '테스트 보험상품',      '000-000-100403', 1000000.00,   'INSURANCE', 0,    1,  0,       100000, '2024-01-01', '2044-01-01', 10000000,    1),
    (2014, 1004, '하나카드',    '테스트 신용카드',      '0000-0000-****-1004', 500000.00,'CARD',      0,  15,  0,       0,      '2024-01-01', '2029-01-01', 5000000,     1),
...
VALUES (3001, 1001, '역삼동 아파트',     'REAL_ESTATE', 920000000.00, '서울 강남구 역삼동 123-45',   84.00, '자가 거주 중인 아파트'),
       (3002, 1001, '그랜저 IG 2021',   'VEHICLE',      28500000.00, '서울 강남구 역삼동 주차장',    0.00,  '2021년식 · 37,200km'),
       (3003, 1001, '금 · 37.5g',       'GOLD',          4380000.00, '하나은행 대여금고',            37.50, 'KRX 금시장 구매분'),
       (3004, 1005, '마포구 아파트',     'REAL_ESTATE', 780000000.00, '서울 마포구 공덕동 456-78',   76.00, '자가 거주 중인 아파트'),
       (3005, 1005, '아반떼 CN7 2022',  'VEHICLE',      18000000.00, '서울 마포구 공덕동 주차장',    0.00,  '2022년식 · 22,500km');
...
VALUES (8001, 1002, '$2a$12$3vbJaMEQ0c8gmy8vOTUq4u0oKkUZEiI584xqRz1bFKHe.drWmV3/G', 'SIMPLE_PASSWORD');
