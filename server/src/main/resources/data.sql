...
-- ========================
INSERT INTO TB_USER (USER_ID, LOGIN_ID, USER_NM, USER_PWD, USER_AGE,
...
VALUES
    ...
    (1010, 'oldUser', '고하나', '$2a$12$ki4mfDlCBGUZLbiPDXIsCu.TVymeZGMU7BmQeEjdUXkq21CHws2Su',
     50, 0, 'ACTIVE', 'PASSWORD', 'ROLE_USER',
     NOW(), '2024-04-17 00:00:00', NULL);
-- ========================
-- TB_PRODUCT
-- ========================
...
VALUES
    ...
    -- 국민연금 연동
    (2020, 1005, '국민연금공단', '국민연금', '701-01-100501', 0.00, 'PENSION_NATIONAL', 0, 25, 950000, 0,
     '2001-03-01', NULL, 0, 1),
    -- 퇴직연금 DC형 연동
    (2021, 1005, '삼성생명', '퇴직연금(DC형)', '702-01-100501', 68000000.00, 'PENSION_RETIRE', 2.8, NULL, 0,
     0, '2008-03-01', NULL, 0, 1);
...
-- TB_CARD_USAGE
-- CARD_ID 참조 전수 조사:
--   9001-9010 → CARD_ID=4001 (TB_CARD에 존재, ACCOUNT_ID=2001, USER_ID=1001) ✓
--   9011-9020 → CARD_ID=4002 (TB_CARD에 존재, ACCOUNT_ID=2001, USER_ID=1001) ✓
-- CREATED_AT 명시: ORDER BY createdAt DESC를 결정적으로 유지
--   이상 거래(ABNML_YN='Y'): 9003, 9007 / 그 중 9007이 가장 최근
-- ========================
INSERT INTO TB_CARD_USAGE (CARD_USAGE_ID, CARD_ID, USAGE_NM, USAGE_LOC, USAGE_TYPE_CD, USAGE_AMT,
                           ABNML_YN, APRVL_YN, CREATED_AT)
VALUES (9001, 4001, '강남성심병원', '서울 강남구 도곡로 117', 'SPEND', 25000.00, 'N', 'Y', '2026-04-01 09:00:00'),
       (9002, 4001, '홍길동', NULL, 'CHARGE', 300000.00, 'N', 'Y', '2026-04-02 10:00:00'),
       (9003, 4001, '네일샵 강남점', '서울 강남구 강남대로 396', 'SPEND', 45000.00, 'Y', 'Y',
        '2026-04-03 11:00:00'),
       (9004, 4001, '삼성서울병원 약국', '서울 강남구 일원로 81', 'SPEND', 18500.00, 'N', 'Y',
        '2026-04-04 09:30:00'),
       (9005, 4001, '강남구보건소', '서울 강남구 삼성로 212', 'SPEND', 5000.00, 'N', 'Y', '2026-04-05 14:00:00'),
       ...
       (9009, 4001, '강남재활의학과', '서울 강남구 역삼로 146', 'SPEND', 32000.00, 'N', 'Y',
        '2026-04-09 11:00:00'),
       (9010, 4001, '한마음약국', '서울 강남구 대치동 944-7', 'SPEND', 9500.00, 'N', 'Y', '2026-04-10 09:00:00'),
       (9011, 4002, '이마트 도곡점', '서울 강남구 도곡로 130', 'SPEND', 62000.00, 'N', 'Y',
        '2026-04-01 10:00:00'),
       (9012, 4002, '홍길동', NULL, 'CHARGE', 200000.00, 'N', 'Y', '2026-04-02 11:00:00'),
       ...
       (9015, 4002, '코리아마트 논현점', '서울 강남구 논현로 430', 'SPEND', 41000.00, 'N', 'Y',
        '2026-04-05 14:00:00'),
       (9016, 4002, '홍길동', NULL, 'CHARGE', 150000.00, 'N', 'Y', '2026-04-06 15:00:00'),
       (9017, 4002, 'CU 논현점', '서울 강남구 논현로 412', 'SPEND', 5800.00, 'N', 'Y', '2026-04-07 16:00:00'),
       (9018, 4002, '롯데마트 강남점', '서울 강남구 대치동 996', 'SPEND', 55000.00, 'N', 'Y',
        '2026-04-08 17:00:00'),
       (9019, 4002, '강남세탁소', '서울 강남구 역삼로 153', 'SPEND', 15000.00, 'N', 'Y', '2026-04-09 18:00:00'),
