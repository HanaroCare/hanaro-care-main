...
public enum ErrorStatus implements BaseErrorCode {
  ...
  AUTH_ACCOUNT_DELETED(HttpStatus.FORBIDDEN, "AUTH_015", "탈퇴 처리된 계정입니다. 고객센터에 문의해주세요."),
  ...
  DORMANT_PHONE_MISMATCH(HttpStatus.BAD_REQUEST, "AUTH_011", "등록된 휴대폰 번호와 일치하지 않습니다."),
  AUTH_NAME_NOT_FOUND(HttpStatus.NOT_FOUND, "AUTH_012", "등록되지 않은 이름입니다."),
  AUTH_LOGIN_ID_NOT_FOUND(HttpStatus.NOT_FOUND, "AUTH_013", "등록되지 않은 아이디입니다."),
  AUTH_USER_NAME_NOT_FOUND(HttpStatus.NOT_FOUND, "AUTH_014", "등록되지 않은 정보입니다."),
  // sms
